...
class GaussianProcessRegressor(sklearn_gp):
    ...
    - The form of the input features is _smooth_, and thus a radial basis
    function kernel (RBF) is a valid kernel choice with initial length scale of
    1 (which is modified during fitting).
    """
    ...
    def __init__(self, *args, kernel=RBF(length_scale=1.0), **kwargs):
    ...
    def sample_y(self, X, n_samples=1, random_state=0):
        """A lightweight wrapper for `scikit-learn's Gaussian Process Regressor
        sample_y <https://scikit-learn.org/stable/modules/generated/
        sklearn.gaussian_process.GaussianProcessRegressor.html
        #sklearn.gaussian_process.GaussianProcessRegressor.sample_y>`_ method.
        Similar to other methods in :class:`.GaussianProcessRegressor`, this
        handles all of the scaling automatically.
        ...
        y = super().sample_y(X, n_samples=n_samples, random_state=random_state)
