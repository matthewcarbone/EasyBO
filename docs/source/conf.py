...
version = easybo.__version__
# The full version, including alpha/beta/rc tags.
release = easybo.__version__
...
exclude_patterns = ["*.txt", "*.dat", "*OUTCAR"]
...
man_pages = [(master_doc, "easybo", "easybo Documentation", [author], 1)]
